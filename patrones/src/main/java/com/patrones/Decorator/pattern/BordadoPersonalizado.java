 ...
 */
public class BordadoPersonalizado extends com.patrones.Decorator.DecoradorProductoBase {
     ...
     */
    public BordadoPersonalizado(com.patrones.Decorator.IProducto productoDecorado) {
